...
class _AccessWidgetState extends State<AccessWidget> with RouteAware {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            height: 40.0,
            decoration: BoxDecoration(
              color: FlutterFlowTheme.of(context).breaker500Color,
          ...
          Padding(
            padding: EdgeInsetsDirectional.fromSTEB(30.0, 23.0, 30.0, 30.0),
            child: Column(
              mainAxisSize: MainAxisSize.max,
              children: [
                Padding(
                  ...
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text:
                              'La siguiente persona desea acceder a tu documento\n',
                        ...
                        TextSpan(
                          text: '\"Evaluación Cardiológica 2024\"',
                          style: FlutterFlowTheme.of(context)
                              .bodyMedium
                              .override(
                                fontFamily: FlutterFlowTheme.of(context)
                ...
                FlutterFlowDropDown<String>(
                  ...
                  hintText: 'Elegir periodo',
                  icon: Icon(
                    Icons.keyboard_arrow_down_rounded,
                    color: Color(0xFF004645),
                    size: 24.0,
                  ),
                  fillColor: Colors.transparent,
                  elevation: 2.0,
                  borderColor: Color(0xFF004645),
                  borderWidth: 1.0,
                  borderRadius: 8.0,
